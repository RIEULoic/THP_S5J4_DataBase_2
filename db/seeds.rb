...
10.times do 
  strolls = Stroll.create!(date: Faker::Date.between(from: '2020-01-01', to: '2022-02-10'), dog_id: Dog.all.sample.id, dogsitter_id: Dogsitter.all.sample.id, city_id: City.all.sample.id)
end
